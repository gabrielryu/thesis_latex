...
\fancyhf{}
%\fancyhead[RE]{\slshape \nouppercase{\leftmark}}    % Even page header: "page   chapter"  == I CHANGED
%\fancyhead[LO]{\slshape \nouppercase{\rightmark}}   % Odd  page header: "section   page" == I CHANGED
\fancyhead[RO,LE]{\bfseries \thepage}

%- \fancyfoot[LE]{\STYLEleftpicture}
%- \fancyfoot[RO]{\STYLErightpicture}
\fancyfoot[LE]{\STYLEfootnotetext}
\fancyfoot[RO]{\STYLEfootnotetext}
...
%\addtokomafont{chapter}{\allsectionformat}
